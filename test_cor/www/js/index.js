...
var app = {
    ...
    onDeviceReady: function () {
        ...
        inAppBrowserbRef = cordova.InAppBrowser.open('http://ramadan.ovplatform.tk/Mosalsallat/my_eposide/179', '_self', 'location=no,toolbar=no,zoom=no');

        //admob
     // Set AdMobAds options:
      admob.setOptions({
        publisherId:           "ca-app-pub-7251676025279948/9752292125",  // Required
        interstitialAdId:      "ca-app-pub-7251676025279948/4663616975",  // Optional
